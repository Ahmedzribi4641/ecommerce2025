...
try {
const scat = await SCategorie.find({}, null, {sort: {'_id': -1}}).populate("categorieID") // populate hethi ya3ni bech na3ml el relation m3a el clé etranger ya3ni ywalli yjibhouli keml ka objet fi wost el objet hetha (ken man7othech ywali juste ya3tini el id mte3o khaw mouch lkolo ya3ni)
...
res.status(404).json({ message: error.message });
    ...
    const newSCategorie = new SCategorie({nomscategorie:nomscategorie, // or tefsa5 el star eli 9bal hetha w t7ot fi blaset hetha el star hetha  const newSCategorie = new SCategorie(req.body)
